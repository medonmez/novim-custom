...
M.workbench = {
  ...
  { display = "y", keys = { "y" }, desc = "Copy file or folder (Files view)" },
  { display = "p", keys = { "p" }, desc = "Paste copied file or folder (Files view)" },
  { display = "M", keys = { "M" }, desc = "Move copied file or folder (Files view)" },
